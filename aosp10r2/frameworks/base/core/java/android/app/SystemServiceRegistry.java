...
final class SystemServiceRegistry {
    ...
    static {
        ...
        registerService(Context.GODROM_SERVICE,GodRomManager.class,
                new CachedServiceFetcher<GodRomManager>(){
                    @Override
                    public GodRomManager createService(ContextImpl ctx){
                        IBinder b = ServiceManager.getService(Context.GODROM_SERVICE);
                        return new GodRomManager(ctx,IGodRom.Stub.asInterface(b));
                    } });
