...
class ArtMethod final {
 public:
  ...
  static bool IsInvkPrint() REQUIRES_SHARED(Locks::mutator_lock_);
  static bool IsJNIMdPrint() REQUIRES_SHARED(Locks::mutator_lock_);
  static bool IsRegNativePrint() REQUIRES_SHARED(Locks::mutator_lock_);
  static const char* GetTraceMd() REQUIRES_SHARED(Locks::mutator_lock_);
  static const char* GetDebugMd() REQUIRES_SHARED(Locks::mutator_lock_);
  static bool IsTuo();
  static bool IsDeepInvk() REQUIRES_SHARED(Locks::mutator_lock_);
  static char* GetPkgName() REQUIRES_SHARED(Locks::mutator_lock_);
  static void SetPkgItem(JNIEnv* env,jobject config);
