...
public final class DexFile {
   ...
   */
    ...
    //add
    private static native void fatrextMethodCode(Object m);
    private static native boolean setGodRomConfig(Object configJson);
    private static native void duppRepair();
    //add end
